...
- (void)noteSignInSuccessfulInfoWithLatestLoginNetRespondBean:(LoginNetRespondBean *)latestLoginNetRespondBean
  ...
  if (latestLoginNetRespondBean == nil) {
    NSAssert(NO, @"latestLoginNetRespondBean is null !");
    return;
  }
  ...
  _latestLoginNetRespondBean.loginName = usernameForLastSuccessfulLogon;
  _latestLoginNetRespondBean.password = passwordForLastSuccessfulLogon;
...
- (void)noteSignOutSuccessfulInfo {
  // 用户登出了
  _latestLoginNetRespondBean = nil;
